...
export default function ComboCard({ promotion }: ComboCardProps) {
  ...
  return (
    <div
      className="rounded-3xl overflow-visible shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col h-full w-full border-0 group relative pt-8 mb-6"
