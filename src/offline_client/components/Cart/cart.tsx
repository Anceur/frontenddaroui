              ...
              <div className="flex-1 overflow-y-auto space-y-2 sm:space-y-3 pr-1 sm:pr-2 min-h-0">
                {cartItems.length === 0 ? (
                  <div className="flex flex-col items-center justify-center mt-10 sm:mt-20">
                    ...
                    <p className="text-center text-gray-500 text-base sm:text-lg font-medium">Votre panier est vide</p>
                    <p className="text-center text-gray-400 text-xs sm:text-sm mt-2">Ajoutez des articles pour commencer !</p>
                  </div>
                ) : (
                  cartItems.map(item => (
